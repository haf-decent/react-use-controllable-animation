...
exports.easingFunctions = {
    ...
    easeInOutExpo: function (val) { return (val < 0.5
        ? exports.easingFunctions.easeInExpo(2 * val) / 2
    ...
    easeInBounce: function (val) { return (1 - exports.easingFunctions.easeOutBounce(1 - val)); },
    ...
    easeInOutBounce: function (val) { return val < 0.5 ?
        (1 - exports.easingFunctions.easeOutBounce(1 - 2 * val)) / 2 :
        (1 + exports.easingFunctions.easeOutBounce(2 * val - 1)) / 2; }
};
exports.default = exports.easingFunctions;
